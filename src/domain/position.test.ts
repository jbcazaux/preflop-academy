...
describe('position', () => {
  it('should get hero position', () => {
    ...
    expect(heroPositionFromButtonPosition(2)).toBe(Position.HJ)
  ...
  it('should get vilain position @ seat 1', () => {
    ...
    expect(positionBySeatNumberAndButtonPosition(1, 3)).toBe(Position.HJ)
  ...
  it('should get vilain position @ seat 2', () => {
    ...
    expect(positionBySeatNumberAndButtonPosition(2, 4)).toBe(Position.HJ)
  ...
  it('should get vilain position @ seat 3', () => {
    ...
    expect(positionBySeatNumberAndButtonPosition(3, 5)).toBe(Position.HJ)
  })
  it('should get vilain position @ seat 4', () => {
    expect(positionBySeatNumberAndButtonPosition(4, 0)).toBe(Position.HJ)
  ...
  it('should get vilain position @ seat 5', () => {
    ...
    expect(positionBySeatNumberAndButtonPosition(5, 1)).toBe(Position.HJ)
  ...
  it('should get seat number of HJ', () => {
    expect(seatNumberByPositionAndButtonPosition(Position.HJ, 0)).toBe(4)
    expect(seatNumberByPositionAndButtonPosition(Position.HJ, 1)).toBe(5)
    expect(seatNumberByPositionAndButtonPosition(Position.HJ, 2)).toBe(0)
    expect(seatNumberByPositionAndButtonPosition(Position.HJ, 3)).toBe(1)
    expect(seatNumberByPositionAndButtonPosition(Position.HJ, 4)).toBe(2)
    expect(seatNumberByPositionAndButtonPosition(Position.HJ, 5)).toBe(3)
  })
